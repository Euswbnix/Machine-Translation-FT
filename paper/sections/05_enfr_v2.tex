...
\begin{enumerate}
\item \textbf{Row-wise (capacity gap):} on clean data Big beats Base by $+0.56$; on noisy data Big trails Base by $-0.87$. A single architectural change has opposite effects on opposite-quality data.
