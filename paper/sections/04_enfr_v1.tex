...
This section reports the two success runs that establish the clean-data baseline of the 2$\times$2: Base v1.1 and Big v1.1 on the strict-filter 9.3M en-fr corpus. Both land within or above the sacrebleu-equivalent of the original paper's reported BLEU, and Big exceeds Base by $+0.56$ test BLEU.
